...
export default function ManageEventPage({
  ...
  if (!event || event.host_id !== user?.id) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-20 text-center text-[#6B7280]">
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-2xl">
        <div className="flex items-center justify-between p-4 border-b border-[#F3F4F6]">
          <h2 className="font-semibold text-[#1F2937]">
            Danh Sách Thành Viên ({approvedBookings.length} đã duyệt /{" "}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      className={`text-[11px] px-2 py-0.5 rounded-full ${booking.approval_status === "approved" ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"}`}
                    >
                    ...
                    <span
                      className={`text-[11px] px-2 py-0.5 rounded-full ${booking.is_paid ? "bg-blue-100 text-blue-700" : "bg-slate-100 text-slate-600"}`}
                    >
