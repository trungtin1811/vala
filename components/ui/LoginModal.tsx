...
export function LoginModal({ open, onClose }: LoginModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div ref={ref} className="relative bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden">
        {/* Close */}
        <button
          onClick={onClose}
        ...
        <div className="px-8 pt-10 pb-6 text-center">
          ...
          <h2 className="text-xl font-bold text-[#1F2937]">Đăng nhập vào Vala</h2>
          <p className="text-sm text-[#6B7280] mt-1.5">Chọn phương thức đăng nhập</p>
        </div>
        ...
        <div className="px-8 pb-8 flex flex-col gap-3">
          ...
          >
            ...
            <span className="flex-1 text-center">Email / Mật khẩu (sắp có)</span>
          </button>
